...
export default function PageEdit({ measurement }) {
    const { data, setData, patch, errors, processing, recentlySuccessful } =
        useForm({
            name: measurement.name,
            abbreviation: measurement.abbreviation,
            is_active: measurement.is_active ? true : false,
        });

    const handleSubmit = (e) => {
        e.preventDefault();

        patch(route('measurements.update', { id: measurement.id }));
    };
    ...
    return (
        <AuthenticatedLayout
            ...
            <MainCard content={false} title="Edit Measurement" sx={{ '& .MuiInputLabel-root': { fontSize: '0.875rem' } }}>
