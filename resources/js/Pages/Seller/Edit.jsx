...
export default function Create({ seller, positions }) {
    ...
    const { data, setData, patch, errors, processing, recentlySuccessful } =
        useForm({
            ...
            is_active: seller.is_active ? true : false,
        });

    const handleSubmit = (e) => {
        e.preventDefault();

        patch(route('sellers.update', { id: seller.id }));
    };
    return (
        <AuthenticatedLayout
            header={
            ...
            <MainCard content={false} title="Edit Seller" sx={{ '& .MuiInputLabel-root': { fontSize: '0.875rem' } }}>
