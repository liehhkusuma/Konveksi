...
export default function Create({ product, materials: mr_materials, measurements }) {
    ...
    return (
        <AuthenticatedLayout
            ...
            <MainCard content={false} title="Edit Product" sx={{ '& .MuiInputLabel-root': { fontSize: '0.875rem' } }}>
