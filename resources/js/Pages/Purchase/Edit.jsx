...
export default function Create({ purchase, materials: mr_materials, measurements, distributors }) {
    ...
    const handleSubmit = (e) => {
        ...
        patch(route('purchases.update', { id: purchase.id }));
    };
    ...
    return (
        <AuthenticatedLayout
            ...
            <MainCard content={false} title="Edit Purchase" sx={{ '& .MuiInputLabel-root': { fontSize: '0.875rem' } }}>
