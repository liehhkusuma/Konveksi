        ...
        },
        {
            ...
            cell: ({ row }) => {
                return <Stack alignItems="center" spacing={2}>
                    <Typography variant="body1">{'Interior: ' + formatter.format(row.original.interior_production_price)}</Typography>
                    <Typography variant="body1">{'Exterior: ' + formatter.format(row.original.exterior_production_price)}</Typography>
                </Stack>
            }
        },
        {
