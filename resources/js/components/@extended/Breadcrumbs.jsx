    ...
    useEffect(() => {
        navigation?.items?.map((menu) => {
            if (menu.type && menu.type === 'group') {
                if (menu?.url && pathname.startsWith(menu.pathname)) {
                    setMain(menu);
                    setItem(menu);
                } else {
                    getCollapse(menu);
        ...
        if (!custom && menu.children) {
            menu.children.filter((collapse) => {
                if (collapse.type && collapse.type === 'collapse') {
                    ...
                    if (pathname.startsWith(collapse.pathname)) {
                        setMain(collapse);
                        setItem(collapse);
                    }
    ...
    if (!custom && main && main.type === 'collapse' && main.breadcrumbs === true) {
        ...
        mainContent = (
            <Typography
                ...
                color={window.location.pathname === main.pathname ? 'text.secondary' : 'text.primary'}
            >
